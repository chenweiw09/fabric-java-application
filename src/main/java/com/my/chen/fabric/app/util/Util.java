...
import com.my.chen.fabric.app.user.CAEnrollment;
...
public class Util {
    ...
    // my
    public static CAEnrollment getEnrollment(String privateKeyFilePath, String certificateFilePath) throws IOException, NoSuchAlgorithmException, NoSuchProviderException, InvalidKeySpecException {
